...
export const getInfo = 'user/user/getInfo';

export const add = 'user/feedback/add';

export const  getList = 'user/feedback/getList';

export const repair = 'user/repair/getList';
